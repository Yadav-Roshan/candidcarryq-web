...
import { Heart, Minus, Plus, ShoppingCart, Star, StarHalf, Truck, Shield, RotateCcw } from "lucide-react"
        ...
        <Tabs defaultValue="details" className="mt-8">
          ...
          <TabsContent value="specifications" className="pt-4">
            <div className="space-y-4">
              ...
              {!product.material && !product.dimensions && !product.weight && !product.capacity && (
          ...
          <TabsContent value="shipping" className="pt-4">
            <div className="space-y-4">
              ...
              <p>Express shipping: 1-2 business days (additional charges apply)</p>
              <p>Free shipping on orders over Rs. 5000</p>
              <p>We ship to all major cities in Nepal. Remote locations may require additional delivery time.</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
